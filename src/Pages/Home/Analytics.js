            ...
            <div className="card h-100">
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-center mt-3">
                  <CircularProgressBar
                    percentage={(totalIncomePercent || 0).toFixed(0)}
                    color="green"
                  />
                </div>
                ...
                <div className="d-flex justify-content-center mt-4 mb-2">
                  <CircularProgressBar
                    percentage={(totalExpensePercent || 0).toFixed(0)}
                    color="red"
                  />
                </div>
              </div>
          ...
          <div className="col-lg-3 col-md-6 mb-4">
            <div className="card h-100">
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-center mt-3">
                  <CircularProgressBar
                    percentage={(TurnOverIncomePercent || 0).toFixed(0)}
                    color="green"
                  />
                </div>
                ...
                <div className="d-flex justify-content-center mt-4 mb-4">
                  <CircularProgressBar
                    percentage={(TurnOverExpensePercent || 0).toFixed(0)}
                    color="red"
                  />
                </div>
              </div>
